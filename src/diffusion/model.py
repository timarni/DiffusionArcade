...
from diffusers import UNet2DModel, UNet2DConditionModel, DDIMScheduler, DDPMScheduler, AutoencoderKL
...
=======
                    for (frames, actions), next_frames in val_dataloader:
                        ...
                        noisy_next_frames = self.scheduler.add_noise(clean_next_frames, noise, timesteps)
                        context_frames_noisy = torch.cat([context_frames, noisy_next_frames.unsqueeze(1)], dim=1)
