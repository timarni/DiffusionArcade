...
STATE_BINS = (24, 24, 16, 24, 3, 3, 24) # discretisation for y, y‑vel, x, y, vx, vy, y


### Evaluations for debugging
EVAL_AGENT_SCORE = False
EVAL_CPU_SCORE = False

### Game setting
CPU_SPEED_RATIO = 0.005
PLAYERS_SPEED_RATIO = 0.01
...
def train_agent(fps = 1000, display_screen = False, recording = True): # for visual inspection fps = 30 and display_screen = True
    ### PLE set‑up
    print("Check arguments:", recording)
    ...
    print(f"Game param are: {CPU_SPEED_RATIO}, {PLAYERS_SPEED_RATIO}, {BALL_SPEED_RATIO}")
    ...
    for ep in tqdm(range(EPISODES)):
        ...
        while not done and step < MAX_STEPS:
            ...
            ALPHA = ALPHA*math.cos(0.5*math.pi + (ep/EPISODES)*(0.45*math.pi))
            print(ALPHA)
...
def main():
    ...
    print("Check argument:", args.recording)
    # TRAINING
